...
<html>
  ...
  <div class="container">
    <div id = "cf">
      <img class = "bottom" src="photos/photo1.jpg" alt="photo1" >
      <img class = "top" src="photos/photo5.jpg" alt="photo2" >
    </div>
    ...
    <div class="archive">
      ...
      <a class="grow" href="phones.jsp">
        <article class="article">
          <img  src="photos/phone1.jpg" alt="phone" >
