...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="mydiv">
            <div class="row">
                <div class="column">
                    <img src="asus.jpg" alt="Asus" style="width:100%" onclick="myFunction(this);">
                </div>
                <div class="column">
                    <img src="asus2.jpg" alt="Asus" style="width:100%" onclick="myFunction(this);">
                </div>
                <div class="column">
                    <img src="asus3.jpg" alt="Asus" style="width:100%" onclick="myFunction(this);">
                </div>
                <div class="column">
                    <img src="asus4.jpg" alt="Asus" style="width:100%" onclick="myFunction(this);">
                </div>
            </div>

            <div class="gallery">
                <img src="asus.jpg" id="expandedImg" style="width:100%">
                <div id="imgtext"></div>
            </div>
        </div>
