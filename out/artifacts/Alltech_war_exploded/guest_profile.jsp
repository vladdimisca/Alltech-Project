    ...
    <body>
        ...
        <div class="container">
            ...
            <hr>
                ...
                <input pattern="^(?=[A-Z0-9][A-Z0-9@._%+-]{5,253}+$)[A-Z0-9._%+-]{1,64}+@(?:(?=[A-Z0-9-]{1,63}+\.)[A-Z0-9]++(?:-[A-Z0-9]++)*+\.){1,8}+[A-Z]{2,63}+$" type="text" placeholder="Enter Email" name="email" id="email" required title="Email pattern">
