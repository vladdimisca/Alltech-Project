...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="mydiv">
            <div class="row">
                <div class="column">
                    <img src="Curved.jpeg" alt="TV" style="width:100%" onclick="myFunction(this);">
                </div>
                <div class="column">
                    <img src="Curved2.jpeg" alt="TV" style="width:100%" onclick="myFunction(this);">
                </div>
                <div class="column">
                    <img src="Curved3.jpeg" alt="TV" style="width:100%" onclick="myFunction(this);">
                </div>
                <div class="column">
                    <img src="Curved4.jpg" alt="TV" style="width:100%" onclick="myFunction(this);">
                </div>
            </div>

            <div class="gallery">
                <img src="Curved.jpeg" id="expandedImg" style="width:100%">
                <div id="imgtext"></div>
            </div>
        </div>
