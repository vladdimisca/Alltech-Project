...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="mydiv">
            <div class="row">
                <div class="column">
                    <img src="apple.jpg" alt="Apple" style="width:100%" onclick="myFunction(this);">
                </div>
                <div class="column">
                    <img src="apple2.jpg" alt="Apple" style="width:100%" onclick="myFunction(this);">
                </div>
                <div class="column">
                    <img src="apple3.jpg" alt="Apple" style="width:100%" onclick="myFunction(this);">
                </div>
                <div class="column">
                    <img src="apple4.jpg" alt="Apple" style="width:100%" onclick="myFunction(this);">
                </div>
            </div>

            <div class="gallery">
                <img src="Apple.jpg" id="expandedImg" style="width:100%">
                <div id="imgtext"></div>
            </div>
        </div>
